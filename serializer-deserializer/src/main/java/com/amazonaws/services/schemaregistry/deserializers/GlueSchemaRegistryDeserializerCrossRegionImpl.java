 ...
 * {@inheritDoc}
 */
public class GlueSchemaRegistryDeserializerCrossRegionImpl implements GlueSchemaRegistryDeserializer {
     ...
     */
    public GlueSchemaRegistryDeserializerCrossRegionImpl(
            final AwsCredentialsProvider awsCredentialsProvider,
            final GlueSchemaRegistryConfiguration configuration) {
        this.glueSchemaRegistryDeserializationFacade = new GlueSchemaRegistryDeserializationFacade(configuration, awsCredentialsProvider, true);
    }
    ...
    @VisibleForTesting
    protected GlueSchemaRegistryDeserializerCrossRegionImpl(final GlueSchemaRegistryDeserializationFacade glueSchemaRegistryDeserializationFacade) {
